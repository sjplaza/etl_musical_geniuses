...
//Read the data
d3.csv("./data_files/steph_years.csv", function (data) {
    ...
    let myColor = d3.scaleOrdinal()
        .domain(["Dance", "Energy", "Speech", "Tempo"])
        .range(d3.schemeSet1);
    ...
    svg.append('g')
        ...
        .attr("r", function (d) { return z(d.tempo); })
    ...
    var size = 20
    var allgroups = ["Dance", "Energy", "Speech", "Tempo"]
